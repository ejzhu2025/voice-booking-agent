#!/usr/bin/env python3
"""Test professional reservation script."""
...
async def test_professional_flow():
    """Test professional reservation flow."""
    print("=" * 70)
    print("Testing Professional Reservation Script")
    print("=" * 70)
    print()

    agent = BookingAgent()

    # Scenario 1: User asks about availability first
    print("Scenario 1: User asks about availability first")
    print("-" * 70)
    conversation = [
        "do you have a table for 3 tonight?",
    ]
    ...
    print("=" * 70)
    print("Professional script test completed!")
    print("=" * 70)


if __name__ == "__main__":
    asyncio.run(test_professional_flow())
